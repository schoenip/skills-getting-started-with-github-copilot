               ...
               ${details.participants
                 .map(
                   (participant) => `<li>
                     ...
                     <button class="delete-participant-button" type="button" data-activity="${encodeURIComponent(
                       name
                     )}" data-email="${encodeURIComponent(participant)}" title="Unregister ${participant}">×</button>
                   </li>`
                 )
                 .join("")}
             </ul>`
